...
public class Sign_up extends javax.swing.JFrame {
    ...
    private void CreatAccountButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                   
       Account acc=new Account();
        if(FirstNameTextField.getText().isEmpty() || LastNameTextField.getText().isEmpty() || PasswordTextField.getText().isEmpty() ||PhoneTextField.getText().isEmpty() ||EmailTextField.getText().isEmpty() )
            ...
            user_database.Insert_users(FirstNameTextField.getText(),LastNameTextField.getText(),Integer.parseInt(PhoneTextField.getText()),EmailTextField.getText(),PasswordTextField.getText());
//          acc.setInfo(FirstNameTextField.getText(),LastNameTextField.getText());
            acc.setEmail(EmailTextField.getText());
            this.dispose();
